...
<div class="d-flex justify-content-between align-items-center mb-4">
  <div>
    ...
    <p class="text-muted mb-0 small">Create a batch per period, add transfers, and export to Excel.</p>
  </div>
...
<div class="card py-5 text-center">
  <div class="card-body">
    ...
    <p class="text-muted small">Each batch represents one set of transfers (e.g. "APRIL 2026").</p>
    <button class="btn btn-primary"
            data-bs-toggle="modal" data-bs-target="#newBatchModal">
...
<!-- ── New Batch Modal ─────────────────────────────────────────────── -->
<div class="modal fade" id="newBatchModal" tabindex="-1" aria-labelledby="newBatchLabel">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header modal-header-primary">
        <h5 class="modal-title" id="newBatchLabel">
          <i class="bi bi-plus-circle me-2"></i>New Transfer Batch
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <form method="post" action="index.php?action=create_date">
        <div class="modal-body">
          <label for="batchName" class="form-label fw-semibold">Batch Name</label>
          <input type="text" class="form-control form-control-lg"
                 id="batchName" name="name"
                 placeholder="e.g.  APRIL 2026" required autofocus>
          <div class="form-text mt-2">
            <i class="bi bi-info-circle me-1"></i>
            Used as the Excel sheet name. Automatically uppercased.
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
          <button type="submit" class="btn btn-primary">
            <i class="bi bi-check2-circle me-2"></i>Create Batch
          </button>
        </div>
      </form>
    </div>
